 ...
 * @author user
 */
public class TeacherProfileSession extends javax.swing.JFrame {
    
    private MainSession mainSession;
    /**
     * Creates new form ProfileSession
     */
    public TeacherProfileSession() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherProfileSession.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherProfileSession().setVisible(true);
            }
        });
    }
